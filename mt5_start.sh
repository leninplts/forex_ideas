#!/bin/bash
# =============================================================================
# Script de inicio corregido para gmag11/metatrader5_vnc
# Fix: el flag -w no existe en versiones recientes de mt5linux/rpyc
# Se monta sobre /Metatrader/start.sh en el container
# =============================================================================
...
# =====================================================================
# FIX: Iniciar el servidor RPyC SIN el flag -w (no existe en rpyc nuevo)
# Original roto: python3 -m mt5linux --host 0.0.0.0 -p $mt5server_port -w $wine_executable python.exe
# =====================================================================
